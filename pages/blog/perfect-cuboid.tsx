        ...
        <div className={classes.diagramContainer}>
          <div>
            ...
            <div className={classes.labels}>
              ...
              <div style={{ left: '240px', top: '184px' }}>\(e\)</div>
              <div style={{ left: '140px', top: '44px' }}>\(f\)</div>
